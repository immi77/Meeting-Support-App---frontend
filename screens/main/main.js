...
import * as HardwareBackHandler from "../../navigation/hardwareBackHandler"
import { Audio } from 'expo-av'

const greenHat = require("@@assets/hats/green.png")
const redHat = require("@@assets/hats/red.png")
const whiteHat = require("@@assets/hats/white.png")
const blackHat = require("@@assets/hats/black.png")
const blueHat = require("@@assets/hats/blue.png")
const yellowHat = require("@@assets/hats/yellow.png")

export default function Main({ navigation, route }) {

    BackHandler.addEventListener("hardwareBackPress", HardwareBackHandler.handleBack)

    // hier weiter machen TODO TODO TODO
    // meeting
    const { meetingId } = route.params
    const [id, setId] = useState(meetingId)
    ...
    return (
        <SafeAreaView style={style.container}>
            ...
            <IconButton iconName={"edit"} text={"Surveys"} buttonStyle={{ paddingLeft: 30 }} textStyle={{ paddingLeft: 15 }} onPress={() => navigation.navigate("Index", { userName: members[0].name, surveys: surveys })} />
        </SafeAreaView>
    )
}
